...
(() => {
  ...
  function cardImage(emp) {
    return emp.hero || "agosto-assets/fachada.jpg";
  }
...
const canCopyImage = () => Boolean(window.ClipboardItem && navigator.clipboard?.write);
  ...
  function buildPrintSheet(enterprises) {
    ...
    setHtml("print-sheet", `
      <header class="ps-head">
        <img class="ps-logo" src="${escapeHtml(assetUrl("agosto-assets/senger-logo.png"))}" alt="Construtora Senger">
        <div>
  ...
  function registerServiceWorker() {
    if ("serviceWorker" in navigator && location.protocol.startsWith("http")) {
      /* teste de agosto: sem service worker */
    }
  }
